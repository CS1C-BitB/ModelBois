...
public:
    /**
     * @brief id_t renames unsigned ints
     *
     * This name is used for any variable which is defined as an unsigned int
     */
    using id_t = unsigned int;

    /**
     * @brief Shape Constructor.
     * @param pos location of your shape
    ...
    /**
     * @brief Shape Copy Constructor.
     * @param Shape The copy constructor requires that it receives a shape
     */
     ...
     * @param pass in another shape object to make a copy to the current shape
